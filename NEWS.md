...
* In `frag.graph.reduce()` add parameters to preserve the proportion of fragments in the first and second spatial units, to preserve connection relationships between fragments from different spatial units, and to control the verbosity of the function.
